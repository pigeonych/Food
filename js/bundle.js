...
function slider({
  ...
  slidesField.style.transition = "0.5s all"; // Slides wrapper => overflow: hidden;

  slidesWrapper.style.overflow = "hidden"; // Slides => width: 650px;
...
window.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)(".modal"), 50000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".timer", "2021-10-30");
